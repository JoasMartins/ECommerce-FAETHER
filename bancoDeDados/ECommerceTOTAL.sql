...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17/11/2025 às 00:56
...
--
-- Estrutura para tabela `produtosvenda`
--
...
--
-- Índices de tabela `produtosvenda`
--
ALTER TABLE `produtosvenda`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `produtosvenda`
--
ALTER TABLE `produtosvenda`
